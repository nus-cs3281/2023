...
|Date|Achievements|
|----|------------|
|May 9, 2022|Reviewed PR: [Instructor editing questions: tweak the confirmation dialog for cancelling an edit #11775](https://github.com/TEAMMATES/teammates/pull/11775)|
...
|May 28, 2022|Reviewed PR: [Change STUDENTS and TEAMS to *_EXCLUDING_SELF for feedback paths #11815](https://github.com/TEAMMATES/teammates/pull/11815)|
|May 28, 2022|Reviewed PR: [Admin search page: differentiate binned courses #11806](https://github.com/TEAMMATES/teammates/pull/11806)|
|May 29, 2022|Reviewed PR: [Admin search results: show more info #11809](https://github.com/TEAMMATES/teammates/pull/11809)|
|Jun 1, 2022|Reviewed PR: [Prevent users from joining binned courses #11814](https://github.com/TEAMMATES/teammates/pull/11814)|
...
|Jun 11, 2022|Reviewed PR: [Instructor help page: provide a way to direct a user to a specific question #11850](https://github.com/TEAMMATES/teammates/pull/11850)|
...
|Jun 20, 2022|Reviewed PR: [Refactor NavigationService to use Angular's dependency injection for services #11855](https://github.com/TEAMMATES/teammates/pull/11855)|
|Jun 23, 2022|Reviewed PR: [Instructor edit session page: Add scroll to top button #11871](https://github.com/TEAMMATES/teammates/pull/11871)|
...
|4|Reviewed PR: [Navigation menu got collapsed #12057](https://github.com/TEAMMATES/teammates/pull/12057)|
...
|5|Reviewed PR: [Add isMigrated flag to course #12063](https://github.com/TEAMMATES/teammates/pull/12063)|
...
|5|Reviewed PR: [Create notification DB layer for v9 migration #12075](https://github.com/TEAMMATES/teammates/pull/12075)|
|5|Reviewed PR: [Add UsageStatistics entity and db #12076](https://github.com/TEAMMATES/teammates/pull/12076)|
|6|Reviewed PR: [Add accessibility tests workflow #12082](https://github.com/TEAMMATES/teammates/pull/12082)|
|6|Merged PR: [Add Account Entity #12087](https://github.com/TEAMMATES/teammates/pull/12087)|
|6|Reviewed PR: [Create SQL logic for CreateNotificationAction and add relevant tests for v9 migration #12077](https://github.com/TEAMMATES/teammates/pull/12077)|
...
|Recess|Reviewed PR: [Create DeleteNotificationAction SQL logic and add relevant tests and update other tests #12137](https://github.com/TEAMMATES/teammates/pull/12137)|
|Recess|Reviewed PR: [create remaining question and response subtype entities #12138](https://github.com/TEAMMATES/teammates/pull/12138)|
